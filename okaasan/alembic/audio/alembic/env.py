...
db_path = os.path.join(STATIC_FOLDER, "audio.db")
db_url = os.getenv("AUDIO_DATABASE_URI", f"sqlite:///{db_path}")

config.set_main_option("sqlalchemy.url", db_url)

# AudioBase is shared by music/audiobooks/podcasts — import all three so
# autogenerate sees every table.
from okaasan.server.music.models import AudioBase  # noqa: F401
